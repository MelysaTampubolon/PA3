...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="page-head-title h3 mb-0">Dashboard</h1>
</div>
...
<div class="row">
    ...
    <div class="col-xl-3 col-md-6 mb-4">
        <div class="card soldProductBorder shadow h-100 py-2">
            <div class="card-body">
    ...
    <!-- Earnings (Monthly) Card Example -->
    <div class="col-xl-3 col-md-6 mb-4">
        <div class="card transactionAmountBorder shadow h-100 py-2">
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
    ...
    <!-- Earnings (Monthly) Card Example -->
    <div class="col-xl-3 col-md-6 mb-4">
        <div class="card productAmountBorder shadow h-100 py-2">
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
    ...
    <!-- Earnings (Monthly) Card Example -->
    <div class="col-xl-3 col-md-6 mb-4">
        <div class="card supplierAmountBorder shadow h-100 py-2">
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
