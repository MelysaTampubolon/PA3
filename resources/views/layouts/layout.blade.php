...
{{--    <title>SB Admin 2 - Dashboard</title>--}}
    ...
    <link href="templateResources/vendor/datatables/dataTables.bootstrap4.min.css" rel="stylesheet">
...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
            ...
            <div class="sidebar-brand-text mx-3">Pekan <sup>Kuy</sup></div>
        </a>
        ...
        <footer class="sticky-footer bg-white">
            <div class="container my-auto">
                <div class="copyright text-center my-auto">
                    <span>Copyright &copy; Kelompok 7 - PA 3 2021</span>
                </div>
            </div>
        </footer>
        <!-- End of Footer -->
...
<!-- Page level plugins -->
<script src="templateResources/vendor/chart.js/Chart.min.js"></script>
...
<!-- Page level plugins -->
<script src="templateResources/vendor/datatables/jquery.dataTables.min.js"></script>
<script src="templateResources/vendor/datatables/dataTables.bootstrap4.min.js"></script>

<!-- Page level custom scripts -->
<script src="templateResources/js/demo/datatables-demo.js"></script>
